...
public class AssembyView extends ViewPart {
	...
	private void hookContextMenu() {
		...
		menuMgr.addMenuListener(new IMenuListener() {
			...
			public void menuAboutToShow(IMenuManager manager) {
				AssembyView.this.fillContextMenu(manager);
			}
		});
	...
	private void makeActions() {
		...
		this.action1.setText("Action 1"); //$NON-NLS-1$
		this.action1.setToolTipText("Action 1 tooltip"); //$NON-NLS-1$
		...
		this.action2.setText("Action 2"); //$NON-NLS-1$
		this.action2.setToolTipText("Action 2 tooltip"); //$NON-NLS-1$
		this.action2.setImageDescriptor(PlatformUI.getWorkbench().getSharedImages().
				getImageDescriptor(ISharedImages.IMG_OBJS_INFO_TSK));
		this.doubleClickAction = new Action() {
			@Override
			public void run() {
				ISelection selection = AssembyView.this.viewer.getSelection();
	...
	private void hookDoubleClickAction() {
		this.viewer.addDoubleClickListener(new IDoubleClickListener() {
			...
			public void doubleClick(DoubleClickEvent event) {
				AssembyView.this.doubleClickAction.run();
			}
		});
	}
