...
public class NewAssemblySourceWizard extends Wizard implements INewWizard {
	private NewAssemblySourceWizardPage page;
	private ISelection selection;

	/**
	 * Constructor for NewAssemblySourceWizard.
	 */
	public NewAssemblySourceWizard() {
		super();
	...
	public void addPages() {
		this.page = new NewAssemblySourceWizardPage(this.selection);
		addPage(this.page);
	}
	...
	/**
	 * We will initialize file with empty content
	 */
	...
	private void throwCoreException(String message) throws CoreException {
		IStatus status = new Status(IStatus.ERROR,
				AssemblyEditorPlugin.PLUGIN_ID, IStatus.OK, message, null);
